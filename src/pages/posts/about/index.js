  ...
  return (
    ...
    <div className={css.about}>
      ...
      <div className={css.AboutText}> 
        <p>Actuellement en troisième année du Bachelor Développeur Web de Hetic à Paris, je suis en alternance dans l'agence TBWA/Paris en tant que développeur front-end.</p>
        <p>Je sort d'un DUT MMI à Grenoble qui m'a permis d’acquérir une expertise globale sur les métiers du multimédia et de l’internet et de maîtriser des compétences techniques polyvalentes. Cette formation couvre tous les champs du digital. De la réalisation de sites internet à l’animation de communautés, de la création vidéo à la conception de contenus.</p>
